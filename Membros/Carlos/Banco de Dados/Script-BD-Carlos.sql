...
filialMatriz VARCHAR(45) NOT NULL,
	CONSTRAINT chkTipo 
    CHECK (filialMatriz in ('Filial', 'Matriz')),
...
CREATE TABLE sensor (
  ...
  tipoCaptura CHAR(5) NOT NULL,
	CONSTRAINT constCheckTipo CHECK (tipoCaptura IN ('Drone','Pilar')),
  fkCana INT NOT NULL,
...
-- DML
insert into Empresa (razaoSocial,cnpj,ramal,telResponsavel,filialMatriz,responsavel,dataAssContrato,email,senha) values
('Canvi Data Analytics','01.123.456/0001-01','2003-3002','011 98975-9759','Matriz','Carlos','2022-10-01','carlos@gmail.com','carlos123');
...
insert into sensor (tipoCaptura,fkCana) values
('Drone',1);
